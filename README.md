...
the [CurseForge release page](https://minecraft.curseforge.com/projects/just-enough-calculation) or [GitHub releases](https://github.com/Towdium/JustEnoughCalculation/releases).

## Features

- **Client only. No default keybinding. [Set it up](#setup-keybinding) according to yourself.**
- Support get catalyst in [NEI-GTNH](https://github.com/GTNewHorizons/NotEnoughItems)
