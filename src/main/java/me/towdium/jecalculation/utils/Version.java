...
public class Version implements Comparable<Version> {
    ...
    public Version(String version) {
        ...
        if (split.length == 0) {
            ...
            if (versions.length != 3) success1 = false;
            else {
                try {
    ...
    public int compareTo(Version o) {
        ...
        assert o.isSuccess();
        if (this.getMajor() != o.getMajor()) return this.getMajor() < o.getMajor() ? -1 : 1;
        if (this.getMinor() != o.getMinor()) return this.getMinor() < o.getMinor() ? -1 : 1;
        if (this.getPatch() != o.getPatch()) return this.getPatch() < o.getPatch() ? -1 : 1;
        return 0;
    }
