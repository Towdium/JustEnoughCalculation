...
public class Utilities {
    ...
    public static String getModName(Fluid fluid) {
        String name = GameData.getItemRegistry().getNameForObject(fluid);
        JustEnoughCalculation.logger.warn(String.format("fluid name: %s", fluid));
        // TODO check
        return name;
    }
    ...
    public static NBTTagCompound getTag(ItemStack is) {
        ...
        return tagCompound;
        //      TODO check  return is.getOrCreateSubCompound(JustEnoughCalculation.Reference.MODID);
    }
    ...
    public static class I18n {
        ...
        public static List<String> wrap(String s, int width) {
            return new TextWrapper().wrap(s, getLocale(), i -> TextWrapper.renderer.getCharWidth(i), width);
        }

        /**
         * Copy from `net.minecraft.client.resources.Language()` 1.12.2
         *
         * @return Locale
         */
    ...
    public static class Json {
        ...
        private static void write(NBTBase nbt, Writer w) {
            if (nbt instanceof NBTTagCompound) {
                ...
                JustEnoughCalculation.logger.error("nbt is TagList");
                // TODO
