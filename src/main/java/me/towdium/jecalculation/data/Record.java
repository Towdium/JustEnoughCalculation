...
public abstract class Record {
    ...
    public static class RecordRecipe {
        ...
        public RecordRecipe(NBTTagList nbt) {
            StreamSupport.stream(Polyfill.spliterator(nbt), false).filter(g -> g instanceof NBTTagCompound)
                         .forEach(g -> {
                             ...
                             StreamSupport.stream(Polyfill.spliterator(recipes), false)
    ...
    public static class RecordRecent {
        ...
        public RecordRecent(NBTTagList nbt) {
            List<ILabel> ls = StreamSupport.stream(Polyfill.spliterator(nbt), false).filter(n -> n instanceof NBTTagCompound)
