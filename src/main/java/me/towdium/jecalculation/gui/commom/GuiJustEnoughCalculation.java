...
public abstract class GuiJustEnoughCalculation extends GuiContainer {
    ...
    protected RenderItem renderItem = new RenderItem() {
        ...
        public void renderItemOverlayIntoGUI(FontRenderer p_77021_1_,
                                             ...
                                             int p_77021_5_,
                                             String text) {
            if (p_77021_3_ != null && p_77021_3_.hasTagCompound() &&
                p_77021_3_.getTagCompound().getBoolean("jecalculation")) {
                boolean b = p_77021_1_.getUnicodeFlag();
                p_77021_1_.setUnicodeFlag(true);
                super.renderItemOverlayIntoGUI(p_77021_1_, p_77021_2_, p_77021_3_, p_77021_4_, p_77021_5_,
                                               ItemStackWrapper.getDisplayAmount(p_77021_3_));
