...
public class Resource {
    ...
    public static final Resource BTN_YES_D = new Resource(228, 14, 14, 14);
    ...
    public static final Resource BTN_IN_N = new Resource(126, 14, 14, 14);
    public static final Resource BTN_IN_F = new Resource(126, 0, 14, 14);
    public static final Resource BTN_IN_D = new Resource(200, 0, 14, 14);
    public static final Resource BTN_OUT_N = new Resource(140, 14, 14, 14);
    public static final Resource BTN_OUT_F = new Resource(140, 0, 14, 14);
    public static final Resource BTN_OUT_D = new Resource(214, 0, 14, 14);
    public static final Resource BTN_CAT_N = new Resource(154, 14, 14, 14);
    public static final Resource BTN_CAT_F = new Resource(154, 0, 14, 14);
    public static final Resource BTN_CAT_D = new Resource(200, 14, 14, 14);
    public static final Resource BTN_LIST_N = new Resource(168, 14, 14, 14);
    public static final Resource BTN_LIST_F = new Resource(168, 0, 14, 14);
    public static final Resource BTN_LIST_D = new Resource(214, 14, 14, 14);
