...
import me.towdium.jecalculation.JecaTranslator;
...
public class GuiEditor extends JecaGuiContainer {
    ...
    public void initGui() {
        ...
        buttonNew = new GuiButtonExt(42, guiLeft + 108, guiTop + 7, 61, 20,
                                     JecaTranslator.format("gui.editor.newGroup"));
        buttonHelp = new GuiButtonExt(43, guiLeft + 131, guiTop + 75, 38, 18, JecaTranslator.format("gui.editor.help"));
        buttonSave = new GuiButtonExt(44, guiLeft + 131, guiTop + 31, 38, 18, JecaTranslator.format("gui.editor.save"));
        buttonClear = new GuiButtonExt(45, guiLeft + 131, guiTop + 53, 38, 18,
                                       JecaTranslator.format("gui.editor.clear"));
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        drawCenteredStringMultiLine(fontRendererObj, JecaTranslator.format("gui.editor.output"), 7, 44, 31, 61,
                                    0xFFFFFF);
        drawCenteredStringMultiLine(fontRendererObj, JecaTranslator.format("gui.editor.catalyst"), 7, 44, 64, 94,
                                    0xFFFFFF);
        drawCenteredStringMultiLine(fontRendererObj, JecaTranslator.format("gui.editor.input"), 7, 44, 97, 159,
                                    0xFFFFFF);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        this.mc.getTextureManager()
               .bindTexture(new ResourceLocation(JustEnoughCalculation.Reference.MODID, "textures/gui/guiEditor.png"));
        this.drawTexturedModalRect(this.guiLeft, this.guiTop, 0, 0, this.xSize, this.ySize);
    }

    public static class ContainerEditor extends JecaContainer {
        @Override
