 ...
 * @author Towdium
 */
public class PacketSlotUpdate implements IMessage, IMessageHandler<PacketSlotUpdate, IMessage> {
    int slot;
    int playerId;
    ...
    public PacketSlotUpdate(EntityPlayer player, int index){
    ...
    @Override
    public IMessage onMessage(PacketSlotUpdate message, MessageContext context) {
