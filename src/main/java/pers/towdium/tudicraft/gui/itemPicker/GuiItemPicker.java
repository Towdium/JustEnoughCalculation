...
public class GuiItemPicker extends GuiContainer{
    ...
    public void initGui() {
        ...
        searchTextField = new GuiTextField(4, fontRendererObj, guiLeft+90, guiTop+7, 79, 20){
            ...
            public boolean textboxKeyTyped(char p_146201_1_, int p_146201_2_) {
                ...
                Tudicraft.log.info("执行了！"+JEIPlugin.runtime.getItemListOverlay().getFilterText());
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation(Tudicraft.Reference.MODID,"textures/gui/guiItemPicker.png"));
